                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            <TextEffect
                                ...
                                Simple, Sustainable Health & Nutrition Support
                            </TextEffect>
                            <TextEffect
                                per="line"
                                preset="fade-in-blur"
                                ...
                                I provide personalized guidance focused on building healthier habits that are realistic, sustainable, and tailored to each individual. Rather than quick fixes, I emphasize understanding how nutrition and lifestyle choices work together to support long-term health, energy, and confidence.
                            </TextEffect>
    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium">This year, you're walking more on average than you did in 2026.</div>
                <div className="space-y-3">
