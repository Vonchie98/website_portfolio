                        ...
                        <div className="mx-auto max-w-7xl px-6 md:px-12">
                            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                                ...
                                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                                    Tame the Wild West <br /> of Education
                                </h1>
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">In any subject I can help you not only float by, but understand and master the conepts of.</p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">Highly customizable learning schedules and techniques optimized for your betterment, and to ignite your spark for learning.</p>
                            </div>
                                ...
                                <Swiper
                                    ...
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            <div className="mx-auto h-fit w-full flex items-center justify-center text-4xl animate-pulse">
                                                <p>Mathematics</p>
                                            </div>
