        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        href="https://x.com/AFDatavault2493"
                        target="_blank"
                    ...
                    <Link
                        href="https://www.linkedin.com/in/adran-fuentes-b641613a5/"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="LinkedIn"
                        className="text-muted-foreground hover:text-primary block">
                    ...
                    <Link
                        href="https://github.com/Vonchie98"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Github"
                        className="text-muted-foreground hover:text-primary block">
                    ...
                    <Link
                        href="https://www.instagram.com/data_vaults/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <Link
                        href="https://tiktok.com/@datavaults6"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        className="text-muted-foreground hover:text-primary block">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Adran Fuentes Data Vaults, All rights reserved</span>
            </div>
        </ footer >
    )
