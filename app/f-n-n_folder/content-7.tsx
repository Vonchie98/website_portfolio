                ...
                <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
                    ...
                    <div className="relative mt-6 sm:mt-0">
                        <div className="bg-linear-to-b aspect-67/34 relative rounded-2xl from-zinc-300 to-transparent p-px dark:from-zinc-700">
                            <Image src="/content-fnn-dark.jpg" className="hidden rounded-[15px] dark:block" alt="fnn dark" width={1206} height={612} />
                            <Image src="/content-fnn-light.jpg" className="rounded-[15px] shadow dark:hidden" alt="fnn light" width={1206} height={612} />
                        </div>
                    </div>
                </div>
            </div>
